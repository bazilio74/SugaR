...
#define S(mg, eg) make_score(mg, eg)
  ...
  constexpr Score PawnScoresBoard[RANK_NB][FILE_NB] = {
		...
		{ S(+000, +000), S(+000, +000), S(+000, +000), S(+025, +000), S(+025, +000), S(+000, +000), S(+000, +000), S(+000, +000) },
		{ S(+000, +000), S(+000, +000), S(-120, -120), S(+030, +000), S(+030, +000), S(-120, -120), S(+000, +000), S(+000, +000) },
		{ S(+000, +000), S(+000, +000), S(+000, +000), S(+020, +000), S(+020, +000), S(+000, +000), S(+000, +000), S(+000, +000) },
		{ S(+000, +000), S(+000, +000), S(+000, +000), S(+000, +000), S(+000, +000), S(+000, +000), S(+000, +000), S(+000, +000) },
		{ S(+000, +000), S(+000, +000), S(+000, +000), S(+000, +000), S(+000, +000), S(+000, +000), S(+000, +000), S(+000, +000) },
  };
  //	File c Rank 5 anf File f Rank5 (from white side) pawn strategic danger to compensate bonus from pawn storm
  //	because of danger enemy to get protected passed pawn in the center
